...
public class AdvertisementController {
    ...
    public String approveAdvertisementForm(@ModelAttribute("advertisement") @Valid AdvertisementHandling advertisementHandling,
    ...
    public String updateAdvertisementForm(@ModelAttribute("update_advertisement") @Valid AdvertisementHandling advertisementHandling,
                                          BindingResult result, Model model){
        if(result.hasErrors()){
            userService.updateModel(model);
            return "admin/approve_advertisement";
